const title = "ramen profitable";
const korean_title = "라면 수익성";
const date = "July 2009";

const essay_data = [
    {
        english:
            'Now that the term "ramen profitable" has become widespread, I ought to explain precisely what the idea entails.',
        korean: '이제 "라면 수익성"이라는 용어가 널리 퍼졌으니, 그 아이디어가 정확히 무엇을 의미하는지 설명해야겠다.',
    },
    {
        english:
        ...
        korean: '라면 수익성이란 스타트업이 설립자들의 생활비를 겨우 충당할 만큼의 돈을 버는 것을 의미한다. 이는 스타트업들이 전통적으로 목표로 삼았던 수익성과는 다른 형태이다. 전통적인 수익성은 큰 도박이 마침내 결실을 보는 것을 의미하는 반면, 라면 수익성의 주된 중요성은 시간을 벌어준다는 데 있다. [1]("라면 수익성"에서의 "라면"은 가장 저렴한 음식 중 하나인 인스턴트 라면을 의미합니다. 이 용어를 글자 그대로 받아들이지 마세요. 인스턴트 라면만 먹고 사는 것은 매우 건강에 해롭습니다. 쌀과 콩이 더 나은 식품 공급원입니다. 밥솥이 없다면 밥솥에 먼저 투자하세요. 2n인분 쌀과 콩: 올리브 오일 또는 버터, 노란 양파 n개, 기타 신선한 채소; 실험해보세요, 마늘 3n쪽, 흰콩, 강낭콩 또는 검은콩 n 12온스 캔, Knorr 쇠고기 또는 야채 육수 n개, 갓 간 후추 n 티스푼, 커민 가루 3n 티스푼, 쌀 n컵, 가급적 현미. 밥솥에 쌀을 넣으세요. 쌀 포장지에 명시된 대로 물을 넣으세요. (기본: 쌀 1컵당 물 2컵.) 밥솥을 켜고 잊어버리세요. 양파와 다른 채소를 다져서 기름에 볶다가 양파가 투명해질 때까지 상당히 낮은 불에서 볶으세요. 다진 마늘, 후추, 커민, 그리고 약간의 지방을 더 넣고 저으세요. 불을 낮게 유지하세요. 2~3분 더 익힌 다음 콩을 넣고(콩물을 버리지 마세요) 저으세요. 육수 큐브를 넣고 뚜껑을 덮은 후 약한 불에서 최소 10분 더 익히세요. 눌어붙지 않도록 부지런히 저으세요. 돈을 절약하고 싶다면 할인점에서 큰 캔에 든 콩을 구입하세요. 향신료도 대량으로 구입하면 훨씬 저렴합니다. 근처에 인도 식료품점이 있다면 슈퍼마켓의 작은 병과 같은 가격으로 큰 봉지에 든 커민을 구할 수 있을 것입니다.)',
    },
    {
        english:
        ...
        korean: "과거에는 스타트업이 상당한 자금을 조달하고 지출한 후에야 수익을 내는 것이 일반적이었다. 컴퓨터 하드웨어를 만드는 회사는 5년 동안 5천만 달러를 지출하고도 수익을 내지 못할 수 있었다. 하지만 수익을 내기 시작하면 연간 5천만 달러의 매출을 올릴 수도 있었다. 이런 종류의 수익성은 스타트업이 성공했음을 의미한다.",
    },
    {
        english:
        ...
        korean: "라면 수익성은 그 반대 극단에 있다. 즉, 한 달 매출이 3000달러에 불과하더라도 두 달 만에 수익을 내는 스타트업이다. 이는 직원이라고는 거의 아무것도 없이 살 수 있는 25세 설립자 두 명뿐이기 때문이다. 한 달 매출 3000달러가 회사의 성공을 의미하지는 않는다. 하지만 전통적인 방식으로 수익을 내는 회사와 공유하는 것이 있다. 바로 생존을 위해 자금을 조달할 필요가 없다는 점이다.",
    },
    {
        english:
        ...
        korean: "라면 수익성은 최근에야 실현 가능해졌기 때문에 대부분의 사람들에게 생소한 아이디어다. 여전히 많은 스타트업에게는 실현 불가능하다. 예를 들어 대부분의 생명공학 스타트업에게는 해당되지 않을 것이다. 하지만 소프트웨어 스타트업은 이제 매우 저렴해졌기 때문에 많은 소프트웨어 스타트업에게는 가능하다. 많은 경우, 유일한 실제 비용은 설립자들의 생활비뿐이다.",
    },
    {
        english:
        ...
        korean: "이러한 유형의 수익성의 주된 의의는 더 이상 투자자들의 처분에 좌우되지 않는다는 것이다. 만약 여전히 돈을 잃고 있다면, 결국에는 더 많은 자금을 조달하거나 폐업해야 할 것이다. 일단 라면 수익성을 달성하면 이 고통스러운 선택은 사라진다. 여전히 자금을 조달할 수는 있지만, 지금 당장 할 필요는 없다.",
    },
    {
        english:
        ...
        korean: "돈이 필요하지 않다는 것의 가장 명백한 장점은 더 나은 조건을 얻을 수 있다는 것이다. 투자자들이 당신에게 돈이 필요하다는 것을 알면, 때때로 당신을 이용하려 들 것이다. 어떤 투자자들은 심지어 의도적으로 시간을 끌 수도 있는데, 이는 당신이 돈이 떨어질수록 점점 더 유순해질 것이라는 것을 알기 때문이다.",
    },
    {
        english:
        ...
        korean: "하지만 라면 수익성에는 덜 명백한 세 가지 장점도 있다. 첫째, 투자자들에게 당신을 더 매력적으로 보이게 한다. 아무리 작은 규모일지라도 이미 수익을 내고 있다면, 이는 (a) 적어도 누군가에게 돈을 지불하게 할 수 있고, (b) 사람들이 원하는 것을 만드는 데 진심이며, (c) 비용을 낮게 유지할 만큼 충분히 훈련되어 있다는 것을 보여준다.",
    },
    {
        english:
        ...
        korean: "이는 투자자들에게 안심을 준다. 왜냐하면 당신이 그들의 가장 큰 걱정거리 세 가지를 해결했기 때문이다. 똑똑한 설립자와 큰 시장을 가진 회사에 투자했음에도 불구하고 실패하는 것은 흔한 일이다. 이러한 회사들이 실패하는 이유는 대개 (a) 사람들이 그들이 만든 것에 대해 돈을 지불하지 않으려 하거나 (예: 판매하기 너무 어렵거나 시장이 아직 준비되지 않았기 때문에), (b) 설립자들이 사용자에게 필요한 것에 주의를 기울이는 대신 잘못된 문제를 해결했거나, (c) 회사가 너무 많은 돈을 쓰고 돈을 벌기 시작하기 전에 자금을 소진했기 때문이다. 만약 당신이 라면 수익성을 달성했다면, 당신은 이미 이러한 실수들을 피하고 있는 것이다.",
    },
    {
        english:
        ...
        korean: "라면 수익성의 또 다른 장점은 사기 진작에 좋다는 것이다. 회사를 처음 시작할 때는 다소 이론적으로 느껴지는 경향이 있다. 법적으로는 회사이지만, 회사라고 부를 때 거짓말을 하는 것처럼 느껴진다. 사람들이 당신에게 상당한 금액을 지불하기 시작하면 회사가 현실로 느껴지기 시작한다. 그리고 당신 자신의 생활비가 가장 크게 느껴지는 이정표인데, 왜냐하면 그 시점에서 미래의 상태가 뒤바뀌기 때문이다. 이제 죽는 대신 생존이 기본값이 된다.",
    },
    {
        english:
        ...
        korean: "그 정도 규모의 사기 진작은 스타트업에서 매우 가치가 있다. 왜냐하면 스타트업 운영의 정신적 부담감이 그것을 어렵게 만들기 때문이다. 스타트업은 여전히 매우 드물다. 왜 더 많은 사람들이 하지 않을까? 재정적 위험? 어차피 아무것도 저축하지 않는 25세 청년들이 많다. 긴 근무 시간? 일반 직장에서도 그만큼 오래 일하는 사람들이 많다. 사람들이 스타트업을 시작하지 못하게 하는 것은 너무 많은 책임을 져야 한다는 두려움 때문이다. 그리고 이것은 비합리적인 두려움이 아니다. 정말로 감당하기 어렵다. 그 부담을 조금이라도 덜어주는 것은 생존 가능성을 크게 높여줄 것이다.",
    },
    {
        english:
        ...
        korean: "라면 수익성에 도달한 스타트업은 성공할 가능성이 실패할 가능성보다 높을 수 있다. 스타트업 결과의 양극단 분포, 즉 실패하거나 큰돈을 벌거나 하는 것을 고려하면 이는 꽤 흥미진진하다.",
    },
    {
        english:
        ...
        korean: "라면 수익성의 네 번째 장점은 가장 덜 명백하지만 가장 중요할 수 있다. 만약 자금을 조달할 필요가 없다면, 그것을 하기 위해 회사 일을 중단할 필요가 없다.",
    },
    {
        english:
        ...
        korean: "자금 조달은 끔찍하게 산만하다. 생산성이 이전의 3분의 1이라도 되면 운이 좋은 것이다. 그리고 그것은 몇 달 동안 지속될 수 있다.",
    },
    {
        english:
        ...
        korean: "나는 올해 초까지 자금 조달이 왜 그렇게 산만한지 정확히 이해하지 못했다(또는 오히려 기억하지 못했다). 우리가 투자한 스타트업들이 자금 조달로 전환할 때 보통 정체 상태에 빠지는 것을 인지했지만, YC(와이 컴비네이터) 자체가 자금을 조달하기 전까지는 정확한 이유를 기억하지 못했다. 우리는 비교적 쉽게 자금을 조달했다. 처음 요청한 사람들이 승낙했다. 하지만 세부 사항을 조율하는 데 몇 달이 걸렸고, 그동안 나는 거의 아무런 실제 작업도 하지 못했다. 왜 그랬을까? 항상 그것에 대해 생각했기 때문이다.",
    },
    {
        english:
        ...
        korean: "언제든지 스타트업에게는 가장 시급한 문제가 하나씩 있기 마련이다. 이것이 밤에 잠들 때와 아침에 샤워할 때 생각하는 것이다. 그리고 자금 조달을 시작하면, 그것이 당신이 생각하는 문제가 된다. 아침에는 샤워를 한 번만 하고, 그동안 투자자들에 대해 생각하고 있다면 제품에 대해서는 생각하지 않는 것이다.",
    },
    {
        english:
        ...
        korean: "반면에 자금 조달 시기를 선택할 수 있다면, 다른 일에 몰두하고 있지 않을 때를 선택할 수 있고, 아마도 투자 라운드가 빨리 마감되도록 주장할 수도 있을 것이다. 마감 여부에 신경 쓰지 않는다면 투자 라운드가 당신의 생각을 차지하는 것을 피할 수도 있을 것이다.",
    },
    {
        english:
        ...
        korean: '라면 수익성은 정의가 의미하는 것 이상을 의미하지 않는다. 예를 들어, 스타트업을 "부트스트래핑"(외부 투자 없이 자력으로 성장하는 것)한다거나 투자자들로부터 절대 돈을 받지 않을 것이라는 의미는 아니다. 경험적으로 볼 때 이는 그다지 효과적이지 않은 것 같다. 투자를 받지 않고 성공하는 스타트업은 거의 없다. 아마도 스타트업이 저렴해짐에 따라 더 일반적이 될 수도 있을 것이다. 다른 한편으로는, 투자될 돈이 거기에 기다리고 있다. 스타트업이 돈을 덜 필요로 한다면 더 나은 조건으로 돈을 얻을 수 있을 것이고, 이는 그들이 돈을 받을 가능성을 더 높일 것이다. 이는 균형을 이루는 경향이 있을 것이다. [2](투자자로부터 설립자로 권력이 이동하면 실제로 벤처 사업의 규모가 커질 가능성이 높습니다. 제 생각에 투자자들은 현재 설립자들에게 너무 가혹하게 구는 경향이 있습니다. 만약 그들이 그렇게 하는 것을 멈추도록 강요받는다면, 전체 벤처 사업이 더 잘 작동할 것이고, 규제 법규가 제거될 때 항상 볼 수 있는 무역 증가와 같은 것을 볼 수 있을 것입니다. 투자자들은 설립자들에게 가장 큰 고통의 원천 중 하나입니다. 만약 그들이 그렇게 많은 고통을 야기하는 것을 멈춘다면, 설립자가 되는 것이 더 나을 것이고, 만약 설립자가 되는 것이 더 낫다면, 더 많은 사람들이 그렇게 할 것입니다.)',
    },
    {
        english:
        ...
        korean: "라면 수익성이 의미하지 않는 또 다른 것은 제품을 베타 버전으로 출시할 때 비즈니스 모델도 베타 버전으로 해야 한다는 조 크라우스의 아이디어이다. 그는 처음부터 사람들에게 돈을 지불하게 해야 한다고 믿는다. 나는 그것이 너무 제약적이라고 생각한다. 페이스북은 그렇게 하지 않았고, 대부분의 스타트업보다 더 잘 해냈다. 즉시 돈을 버는 것은 그들에게 불필요했을 뿐만 아니라 아마도 해로웠을 것이다. 하지만 조의 규칙이 많은 스타트업에게 유용할 수 있다고 생각한다. 설립자들이 집중하지 못하는 것처럼 보일 때, 나는 때때로 그들에게 고객들이 무언가에 대해 돈을 지불하도록 유도해 보라고 제안하는데, 이는 이러한 제약이 그들을 행동으로 이끌기를 바라기 때문이다.",
    },
    {
        english:
        ...
        korean: "조의 아이디어와 라면 수익성의 차이점은 라면 수익성을 달성한 회사가 궁극적으로 돈을 벌 방식대로 돈을 벌 필요는 없다는 것이다. 그저 돈을 벌기만 하면 된다. 가장 유명한 예는 구글인데, 처음에는 야후와 같은 사이트에 검색 라이선스를 판매하여 돈을 벌었다.",
    },
    {
        english:
        ...
        korean: "라면 수익성에 단점은 없을까? 아마도 가장 큰 위험은 컨설팅 회사로 변질될 수 있다는 것이다. 스타트업은 모든 사람이 사용하는 단일 제품을 만든다는 의미에서 제품 회사여야 한다. 스타트업의 결정적인 특징은 빠르게 성장한다는 것인데, 컨설팅은 제품처럼 확장될 수 없다. [3](스타트업이 컨설팅을 확장 가능한 형태로 전환하여 크게 성장하는 것은 상상할 수 있습니다. 하지만 그렇게 한다면 그들은 실제로는 제품 회사가 될 것입니다.) 하지만 컨설팅으로 한 달에 3000달러를 버는 것은 꽤 쉽다. 사실, 이는 계약 프로그래밍의 낮은 요율일 것이다. 따라서 실제로는 전혀 스타트업이 아니면서 스스로를 라면 수익성을 달성한 스타트업이라고 말하며 컨설팅으로 빠져들 유혹이 있을 수 있다.",
    },
    {
        english:
            "It's ok to do a little consulting-type work at first. Startups usually have to do something weird at first. But remember that ramen profitability is not the destination. A startup's destination is to grow really big; ramen profitability is a trick for not dying en route. Thanks to Jessica Livingston for reading drafts of this.",
        korean: "처음에는 약간의 컨설팅 유형의 작업을 해도 괜찮다. 스타트업은 보통 처음에는 이상한 일을 해야 한다. 하지만 라면 수익성은 목적지가 아니라는 것을 기억하라. 스타트업의 목적지는 정말 크게 성장하는 것이고, 라면 수익성은 도중에 죽지 않기 위한 속임수일 뿐이다. 이 초고를 읽어준 제시카 리빙스턴에게 감사한다.",
    },
];
