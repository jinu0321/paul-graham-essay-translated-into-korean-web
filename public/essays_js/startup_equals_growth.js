const title = "Startup = Growth";
const korean_title = "스타트업 = 성장";
const date = "September 2012";

const essay_data = [
    {
        english:
            'A startup is a company designed to grow fast. Being newly founded does not in itself make a company a startup. Nor is it necessary for a startup to work on technology, or take venture funding, or have some sort of "exit." The only essential thing is growth. Everything else we associate with startups follows from growth.',
        korean: "스타트업은 빠르게 성장하도록 설계된 회사입니다. 신생 기업이라고 해서 그 자체로 스타트업이 되는 것은 아닙니다. 또한 스타트업이 기술을 다루거나, 벤처 자금을 지원받거나, 어떤 종류의 '엑시트(투자금 회수)'를 해야 하는 것도 아닙니다. 유일하게 본질적인 것은 성장입니다. 우리가 스타트업과 연관시키는 다른 모든 것은 성장에서 비롯됩니다.",
    },
    {
        english:
        ...
        korean: "스타트업을 시작하고 싶다면 그 점을 이해하는 것이 중요합니다. 스타트업은 너무 어려워서 옆길로 새어나가 성공을 바랄 수는 없습니다. 성장이 바로 당신이 추구하는 목표라는 것을 알아야 합니다. 좋은 소식은, 성장을 이루면 다른 모든 것이 제자리를 찾아간다는 것입니다. 즉, 성장을 나침반처럼 사용하여 거의 모든 결정에 활용할 수 있다는 의미입니다.",
    },
    {
        english: "Redwoods",
        korean: "레드우드 (거대한 삼나무)",
    },
    {
        ...
        korean: "명백해야 하지만 종종 간과되는 차이점부터 시작하겠습니다. 모든 신생 기업이 스타트업이라고 해서 그 자체로 스타트업이 되는 것은 아닙니다. 미국에서는 매년 수백만 개의 회사가 설립됩니다. 그중 극히 일부만이 스타트업입니다. 대부분은 음식점, 미용실, 배관공 등과 같은 서비스업입니다. 몇몇 예외적인 경우를 제외하고는 이들은 스타트업이 아닙니다. 미용실은 빠르게 성장하도록 설계되지 않았습니다. 반면, 예를 들어 검색 엔진은 그렇습니다.",
    },
    {
        english:
        ...
        korean: "스타트업이 빠르게 성장하도록 설계되었다고 말할 때, 저는 두 가지 의미를 담고 있습니다. 부분적으로는 대부분의 스타트업이 실패하기 때문에 의도된 의미에서의 설계를 의미합니다. 하지만 또한 콩나물과 레드우드 묘목의 운명이 다르듯이, 스타트업은 본질적으로 다르다는 의미이기도 합니다.",
    },
    {
        english:
        ...
        korean: "이러한 차이점 때문에 빠르게 성장하도록 설계된 회사를 지칭하는 '스타트업'이라는 별개의 단어가 있는 것입니다. 만약 모든 회사가 본질적으로 비슷하지만, 일부 운이 좋거나 창업자의 노력으로 매우 빠르게 성장하게 된다면, 별도의 단어가 필요 없을 것입니다. 그냥 매우 성공적인 회사와 덜 성공적인 회사에 대해 이야기하면 됩니다. 그러나 실제로 스타트업은 다른 기업과 다른 종류의 DNA를 가지고 있습니다. 구글은 창업자들이 유난히 운이 좋고 열심히 일했던 미용실이 아닙니다. 구글은 처음부터 달랐습니다.",
    },
    {
        english:
            "To grow rapidly, you need to make something you can sell to a big market. That's the difference between Google and a barbershop. A barbershop doesn't scale.",
        korean: "빠르게 성장하려면 큰 시장에 판매할 수 있는 무언가를 만들어야 합니다. 이것이 구글과 미용실의 차이점입니다. 미용실은 확장성이 없습니다.",
    },
    {
        english:
            "For a company to grow really big, it must (a) make something lots of people want, and (b) reach and serve all those people. Barbershops are doing fine in the (a) department. Almost everyone needs their hair cut. The problem for a barbershop, as for any retail establishment, is (b). A barbershop serves customers in person, and few will travel far for a haircut. And even if they did, the barbershop couldn't accomodate them. [1](Strictly speaking it's not lots of customers you need but a big market, meaning a high product of number of customers times how much they'll pay. But it's dangerous to have too few customers even if they pay a lot, or the power that individual customers have over you could turn you into a de facto consulting firm. So whatever market you're in, you'll usually do best to err on the side of making the broadest type of product for it.)",
        korean: "회사가 정말 크게 성장하려면, (a) 많은 사람들이 원하는 것을 만들고, (b) 그 모든 사람들에게 도달하고 서비스를 제공해야 합니다. 미용실은 (a) 항목에서는 잘하고 있습니다. 거의 모든 사람이 이발을 필요로 합니다. 그러나 다른 소매점과 마찬가지로 미용실의 문제는 (b)입니다. 미용실은 고객에게 직접 서비스를 제공하며, 이발을 위해 멀리까지 오는 사람은 거의 없습니다. 그리고 설령 온다고 해도 미용실은 그들을 모두 수용할 수 없습니다. [1](엄밀히 말하면 많은 고객이 필요한 것이 아니라 큰 시장, 즉 고객 수와 그들이 지불할 금액의 곱이 높은 시장이 필요합니다. 하지만 소수의 고객에게만 의존하는 것은 위험합니다. 고객 개개인이 회사에 미치는 영향력이 너무 커지면 사실상 컨설팅 회사로 전락할 수 있기 때문입니다. 따라서 어떤 시장에 있든 가장 광범위한 유형의 제품을 만드는 방향으로 노력하는 것이 일반적으로 최선입니다.)",
    },
    {
        english:
            "Writing software is a great way to solve (b), but you can still end up constrained in (a). If you write software to teach Tibetan to Hungarian speakers, you'll be able to reach most of the people who want it, but there won't be many of them. If you make software to teach English to Chinese speakers, however, you're in startup territory.",
        korean: "소프트웨어를 작성하는 것은 (b)를 해결하는 좋은 방법이지만, 여전히 (a)에서 제약을 받을 수 있습니다. 만약 헝가리어를 사용하는 사람들에게 티베트어를 가르치는 소프트웨어를 만든다면, 그것을 원하는 대부분의 사람들에게 도달할 수 있겠지만, 그 수는 많지 않을 것입니다. 하지만 중국어를 사용하는 사람들에게 영어를 가르치는 소프트웨어를 만든다면, 당신은 스타트업 영역에 있는 것입니다.",
    },
    {
        english:
            "Most businesses are tightly constrained in (a) or (b). The distinctive feature of successful startups is that they're not.",
        korean: "대부분의 사업은 (a) 또는 (b)에서 심하게 제약을 받습니다. 성공적인 스타트업의 두드러진 특징은 그렇지 않다는 것입니다. 이들은 이러한 제약에서 자유롭습니다.",
    },
    {
        english: "Ideas",
        korean: "아이디어",
    ...
    {
        english:
            "It might seem that it would always be better to start a startup than an ordinary business. If you're going to start a company, why not start the type with the most potential? The catch is that this is a (fairly) efficient market. If you write software to teach Tibetan to Hungarians, you won't have much competition. If you write software to teach English to Chinese speakers, you'll face ferocious competition, precisely because that's such a larger prize. [2](One year at Startup School David Heinemeier Hansson encouraged programmers who wanted to start businesses to use a restaurant as a model. What he meant, I believe, is that it's fine to start software companies constrained in (a) in the same way a restaurant is constrained in (b). I agree. Most people should not try to start startups.)",
        korean: "일반적인 사업보다 스타트업을 시작하는 것이 항상 더 나을 것처럼 보일 수 있습니다. 회사를 시작할 거라면, 왜 가장 잠재력이 큰 유형을 시작하지 않겠습니까? 문제는 이것이 (꽤) 효율적인 시장이라는 점입니다. 헝가리인에게 티베트어를 가르치는 소프트웨어를 만든다면 경쟁이 거의 없을 것입니다. 하지만 중국인에게 영어를 가르치는 소프트웨어를 만든다면, 그것이 훨씬 큰 보상이기 때문에 치열한 경쟁에 직면하게 될 것입니다. [2](어느 해 스타트업 스쿨에서 데이비드 하이네마이어 한손은 사업을 시작하려는 프로그래머들에게 식당을 모델로 삼으라고 격려했습니다. 제 생각에 그의 의미는, 식당이 (b)에서 제약을 받는 것처럼 (a)에서 제약을 받는 소프트웨어 회사를 시작하는 것도 괜찮다는 것이었습니다. 저도 동의합니다. 대부분의 사람들은 스타트업을 시작하려고 해서는 안 됩니다.)",
    },
    {
        english:
        ...
        korean: "일반적인 회사를 제한하는 제약 조건은 또한 그들을 보호합니다. 그것이 트레이드오프(tradeoff, 상호교환적인 관계)입니다. 미용실을 시작하면 다른 지역 미용실과만 경쟁하면 됩니다. 검색 엔진을 시작하면 전 세계와 경쟁해야 합니다.",
    },
    {
        english:
        ...
        korean: "그러나 일반적인 사업에 대한 제약이 사업을 보호하는 가장 중요한 것은 경쟁이 아니라 새로운 아이디어를 생각해내는 어려움입니다. 특정 동네에 술집을 연다면, 잠재력을 제한하고 경쟁자로부터 당신을 보호하는 것 외에도, 그 지리적 제약은 회사를 정의하는 데 도움이 됩니다. '술집 + 동네'는 소규모 사업에 충분한 아이디어입니다. (a)에 제약을 받는 회사도 마찬가지입니다. 당신의 틈새시장은 당신을 보호하고 정의합니다.",
    },
    {
        english:
        ...
        korean: "반면에 스타트업을 시작하고 싶다면, 상당히 새로운 것을 생각해내야 할 것입니다. 스타트업은 큰 시장에 전달할 수 있는 무언가를 만들어야 하며, 그런 유형의 아이디어는 매우 가치가 있어서 명백한 것들은 이미 모두 차지되어 있습니다.",
    },
    {
        english:
            "That space of ideas has been so thoroughly picked over that a startup generally has to work on something everyone else has overlooked. I was going to write that one has to make a conscious effort to find ideas everyone else has overlooked. But that's not how most startups get started. Usually successful startups happen because the founders are sufficiently different from other people that ideas few others can see seem obvious to them. Perhaps later they step back and notice they've found an idea in everyone else's blind spot, and from that point make a deliberate effort to stay there. [3](That sort of stepping back is one of the things we focus on at Y Combinator. It's common for founders to have discovered something intuitively without understanding all its implications. That's probably true of the biggest discoveries in any field.) But at the moment when successful startups get started, much of the innovation is unconscious.",
        korean: "아이디어의 공간은 너무나 철저하게 탐색되어서 스타트업은 일반적으로 다른 모든 사람이 간과한 무언가에 대해 연구해야 합니다. 저는 다른 모든 사람이 간과한 아이디어를 찾기 위해 의식적인 노력을 기울여야 한다고 쓰려고 했습니다. 하지만 대부분의 스타트업은 그렇게 시작되지 않습니다. 일반적으로 성공적인 스타트업은 창업자들이 다른 사람들과 충분히 달라서 다른 사람들은 거의 볼 수 없는 아이디어가 그들에게는 명백해 보이기 때문에 발생합니다. 아마도 나중에 그들은 한 걸음 물러서서 다른 모든 사람의 사각지대에서 아이디어를 찾았다는 것을 알아차리고, 그 시점부터 의도적으로 그곳에 머무르려고 노력할 것입니다. [3](그런 종류의 한 걸음 물러서는 것은 Y Combinator에서 우리가 집중하는 것 중 하나입니다. 창업자들이 모든 함의를 이해하지 못한 채 직관적으로 무언가를 발견하는 것은 흔한 일입니다. 아마도 어떤 분야에서든 가장 큰 발견에 대해서도 마찬가지일 것입니다.) 그러나 성공적인 스타트업이 시작되는 순간에는 많은 혁신이 무의식적입니다.",
    },
    {
        english:
        ...
        korean: "성공한 창업가들의 차이점은 그들이 다른 문제를 볼 수 있다는 것입니다. 기술에 능숙하면서 동시에 기술로 해결할 수 있는 문제에 직면하는 것은 특히 좋은 조합입니다. 왜냐하면 기술은 매우 빠르게 변하기 때문에 이전에는 나빴던 아이디어가 아무도 모르게 좋은 아이디어가 되는 경우가 많기 때문입니다. 스티브 워즈니악의 문제는 자신만의 컴퓨터를 원했다는 것입니다. 1975년에는 그것이 특이한 문제였습니다. 그러나 기술 변화는 곧 그것을 훨씬 더 일반적인 문제로 만들 참이었습니다. 그는 컴퓨터를 원했을 뿐만 아니라 만드는 방법도 알고 있었기 때문에 워즈니악은 직접 컴퓨터를 만들 수 있었습니다. 그리고 그가 스스로 해결한 문제는 애플이 다음 해에 수백만 명의 사람들을 위해 해결한 문제가 되었습니다. 그러나 이것이 큰 시장이라는 것이 일반 사람들에게 명백해졌을 때 애플은 이미 자리를 잡은 후였습니다.",
    },
    {
        english:
        ...
        korean: "구글도 비슷한 기원을 가지고 있습니다. 래리 페이지와 세르게이 브린은 웹을 검색하고 싶었습니다. 그러나 대부분의 사람들과 달리 그들은 기존 검색 엔진이 최선이 아니라는 것을 알아차리고 개선 방법을 알 수 있는 기술적 전문 지식을 모두 갖추고 있었습니다. 다음 몇 년 동안 웹이 성장하여 까다로운 검색 전문가가 아니더라도 이전 알고리즘이 충분히 좋지 않다는 것을 알아차릴 수 있는 크기가 되면서 그들의 문제는 모든 사람의 문제가 되었습니다. 그러나 애플의 경우와 마찬가지로 다른 모든 사람들이 검색의 중요성을 깨달았을 때 구글은 이미 확고한 위치를 차지하고 있었습니다.",
    },
    {
        english:
        ...
        korean: "이것이 스타트업 아이디어와 기술 사이의 한 가지 연결고리입니다. 한 분야의 빠른 변화는 다른 분야에서 크고 해결 가능한 문제를 드러냅니다. 때때로 변화는 발전이며, 그들이 바꾸는 것은 해결 가능성입니다. 그것이 애플을 탄생시킨 종류의 변화였습니다. 칩 기술의 발전은 마침내 스티브 워즈니악이 감당할 수 있는 컴퓨터를 설계하도록 했습니다. 그러나 구글의 경우 가장 중요한 변화는 웹의 성장이었습니다. 거기서 바뀐 것은 해결 가능성이 아니라 거대함이었습니다.",
    },
    {
        english:
            'The other connection between startups and technology is that startups create new ways of doing things, and new ways of doing things are, in the broader sense of the word, new technology. When a startup both begins with an idea exposed by technological change and makes a product consisting of technology in the narrower sense (what used to be called "high technology"), it\'s easy to conflate the two. But the two connections are distinct and in principle one could start a startup that was neither driven by technological change, nor whose product consisted of technology except in the broader sense. [4](I got it wrong in "How to Make Wealth" when I said that a startup was a small company that takes on a hard technical problem. That is the most common recipe but not the only one.)',
        korean: "스타트업과 기술 사이의 또 다른 연결고리는 스타트업이 일을 하는 새로운 방식을 창조하고, 새로운 방식의 일 처리는 넓은 의미에서 새로운 기술이라는 것입니다. 스타트업이 기술 변화에 의해 드러난 아이디어로 시작하고 좁은 의미의 기술(이전에는 '첨단 기술'이라고 불렸던 것)로 구성된 제품을 만들 때, 이 둘을 혼동하기 쉽습니다. 그러나 두 연결고리는 별개이며, 원칙적으로 기술 변화에 의해 주도되지도 않고, 제품이 넓은 의미의 기술 외에는 기술로 구성되지 않은 스타트업을 시작할 수도 있습니다. [4](제가 '부를 창조하는 방법'에서 스타트업을 어려운 기술적 문제를 해결하는 작은 회사라고 말했을 때 틀렸습니다. 그것이 가장 일반적인 방법이긴 하지만 유일한 방법은 아닙니다.)",
    },
    {
        english: "Rate",
        korean: "성장률",
    },
    {
        ...
        korean: "회사가 스타트업으로 간주되려면 얼마나 빨리 성장해야 할까요? 정확한 답은 없습니다. '스타트업'은 기준점이 아니라 지향점입니다. 스타트업을 시작하는 것은 처음에는 자신의 야망을 선언하는 것에 지나지 않습니다. 단순히 회사를 시작하는 것이 아니라 빠르게 성장하는 회사를 시작하겠다고 약속하는 것이며, 따라서 그런 유형의 희귀한 아이디어 중 하나를 찾겠다고 약속하는 것입니다. 하지만 처음에는 약속밖에 없습니다. 그런 점에서 스타트업을 시작하는 것은 배우가 되는 것과 같습니다. '배우' 또한 기준점이 아니라 지향점입니다. 경력 초기에 배우는 오디션을 보러 다니는 웨이터입니다. 일을 얻으면 성공한 배우가 되지만, 성공해야만 배우가 되는 것은 아닙니다.",
    },
    {
        english:
        ...
        korean: "따라서 진짜 질문은 어떤 성장률이 회사를 스타트업으로 만드는가가 아니라, 성공적인 스타트업이 어떤 성장률을 가지는 경향이 있는가입니다. 창업자들에게 이것은 이론적인 질문 이상입니다. 왜냐하면 그들이 올바른 길을 가고 있는지 묻는 것과 같기 때문입니다.",
    },
    {
        english:
            "The growth of a successful startup usually has three phases:\n\nThere's an initial period of slow or no growth while the startup tries to figure out what it's doing.\n\nAs the startup figures out how to make something lots of people want and how to reach those people, there's a period of rapid growth.\n\nEventually a successful startup will grow into a big company. Growth will slow, partly due to internal limits and partly because the company is starting to bump up against the limits of the markets it serves. [5](In principle companies aren't limited by the size of the markets they serve, because they could just expand into new markets. But there seem to be limits on the ability of big companies to do that. Which means the slowdown that comes from bumping up against the limits of one's markets is ultimately just another way in which internal limits are expressed.\n\nIt may be that some of these limits could be overcome by changing the shape of the organization — specifically by sharding it.)\nTogether these three phases produce an S-curve. The phase whose growth defines the startup is the second one, the ascent. Its length and slope determine how big the company will be.",
        korean: "성공적인 스타트업의 성장은 일반적으로 세 단계를 거칩니다.\n\n스타트업이 무엇을 하고 있는지 파악하려고 노력하는 동안 초기에는 성장이 느리거나 전혀 없는 기간이 있습니다.\n\n스타트업이 많은 사람들이 원하는 것을 만들고 그 사람들에게 도달하는 방법을 알아내면서 급격한 성장 기간이 있습니다.\n\n결국 성공적인 스타트업은 대기업으로 성장할 것입니다. 성장은 부분적으로 내부 한계와 부분적으로 회사가 서비스하는 시장의 한계에 부딪히기 시작하기 때문에 느려질 것입니다. [5](원칙적으로 회사는 서비스하는 시장의 크기에 제한받지 않습니다. 왜냐하면 새로운 시장으로 확장할 수 있기 때문입니다. 그러나 대기업이 그렇게 하는 능력에는 한계가 있는 것 같습니다. 이는 시장의 한계에 부딪혀 발생하는 성장 둔화가 궁극적으로 내부 한계가 표현되는 또 다른 방식일 뿐이라는 것을 의미합니다.\n\n이러한 한계 중 일부는 조직의 형태를 변경함으로써, 특히 분할(sharding)함으로써 극복될 수 있을지도 모릅니다.)\n이 세 단계가 함께 S자 곡선을 만듭니다. 스타트업을 정의하는 성장을 보여주는 단계는 두 번째 단계인 상승기입니다. 이 기간의 길이와 기울기가 회사의 규모를 결정합니다.",
    },
    {
        english:
        ...
        korean: "기울기는 회사의 성장률입니다. 모든 창업자가 항상 알아야 할 숫자가 하나 있다면, 그것은 회사의 성장률입니다. 그것이 스타트업의 척도입니다. 그 숫자를 모르면 자신이 잘하고 있는지 못하고 있는지도 모르는 것입니다.",
    },
    {
        english:
        ...
        korean: '제가 처음 창업자들을 만나 그들의 성장률이 얼마인지 물어보면, 때때로 그들은 "한 달에 약 백 명의 신규 고객을 확보합니다."라고 말합니다. 그것은 비율이 아닙니다. 중요한 것은 신규 고객의 절대적인 수가 아니라 기존 고객 대비 신규 고객의 비율입니다. 만약 매달 일정한 수의 신규 고객을 확보하고 있다면, 당신은 곤경에 처한 것입니다. 왜냐하면 그것은 당신의 성장률이 감소하고 있다는 것을 의미하기 때문입니다.',
    },
    {
        english:
            "During Y Combinator we measure growth rate per week, partly because there is so little time before Demo Day, and partly because startups early on need frequent feedback from their users to tweak what they're doing. [6](This is, obviously, only for startups that have already launched or can launch during YC. A startup building a new database will probably not do that. On the other hand, launching something small and then using growth rate as evolutionary pressure is such a valuable technique that any company that could start this way probably should.)",
        korean: "Y Combinator 기간 동안 우리는 주간 성장률을 측정합니다. 부분적으로는 데모 데이까지 시간이 너무 적기 때문이고, 부분적으로는 초기 스타트업이 사용자의 빈번한 피드백을 통해 현재 하고 있는 일을 조정해야 하기 때문입니다. [6](이것은 물론 이미 출시했거나 YC 기간 동안 출시할 수 있는 스타트업에만 해당됩니다. 새로운 데이터베이스를 구축하는 스타트업은 아마도 그렇게 하지 않을 것입니다. 반면에, 작은 것을 출시한 다음 성장률을 진화적 압력으로 사용하는 것은 매우 가치 있는 기술이므로, 이런 방식으로 시작할 수 있는 모든 회사는 아마도 그렇게 해야 할 것입니다.)",
    },
    {
        english:
            "A good growth rate during YC is 5-7% a week. If you can hit 10% a week you're doing exceptionally well. If you can only manage 1%, it's a sign you haven't yet figured out what you're doing.",
        korean: "YC 기간 동안 좋은 성장률은 주당 5-7%입니다. 주당 10%를 달성할 수 있다면 매우 잘하고 있는 것입니다. 만약 1%밖에 관리하지 못한다면, 아직 무엇을 해야 할지 파악하지 못했다는 신호입니다.",
    },
    {
        english:
            "The best thing to measure the growth rate of is revenue. The next best, for startups that aren't charging initially, is active users. That's a reasonable proxy for revenue growth because whenever the startup does start trying to make money, their revenues will probably be a constant multiple of active users. [7](If the startup is taking the Facebook/Twitter route and building something they hope will be very popular but from which they don't yet have a definite plan to make money, the growth rate has to be higher, even though it's a proxy for revenue growth, because such companies need huge numbers of users to succeed at all.\n\nBeware too of the edge case where something spreads rapidly but the churn is high as well, so that you have good net growth till you run through all the potential users, at which point it suddenly stops.)",
        korean: "성장률을 측정하는 가장 좋은 대상은 수익입니다. 처음에는 요금을 부과하지 않는 스타트업의 경우, 그 다음으로 좋은 것은 활성 사용자입니다. 이는 수익 성장에 대한 합리적인 대리 지표입니다. 왜냐하면 스타트업이 수익 창출을 시도하기 시작하면 수익은 아마도 활성 사용자의 상수 배가 될 것이기 때문입니다. [7](스타트업이 페이스북/트위터 경로를 택하여 매우 인기를 얻을 것으로 기대하지만 아직 확실한 수익 창출 계획이 없는 무언가를 만들고 있다면, 그것이 수익 성장의 대리 지표라 할지라도 성장률은 더 높아야 합니다. 왜냐하면 그런 회사들은 성공하기 위해 엄청난 수의 사용자가 필요하기 때문입니다.\n\n또한 무언가가 빠르게 확산되지만 이탈률도 높아서 잠재적 사용자를 모두 소진할 때까지 순 성장이 양호하다가 갑자기 멈추는 극단적인 경우도 주의해야 합니다.)",
    },
    {
        english: "Compass",
        korean: "나침반",
    },
    {
        ...
        korean: "우리는 보통 스타트업에게 달성할 수 있다고 생각하는 성장률을 선택한 다음 매주 그 목표를 달성하기 위해 노력하라고 조언합니다. 여기서 핵심 단어는 '단지(just)'입니다. 만약 그들이 주당 7% 성장하기로 결정하고 그 숫자를 달성한다면, 그 주에는 성공한 것입니다. 더 이상 할 일이 없습니다. 그러나 달성하지 못하면 유일하게 중요했던 일에 실패한 것이므로 그에 상응하는 경각심을 가져야 합니다.",
    },
    {
        english:
        ...
        korean: "프로그래머들은 우리가 여기서 무엇을 하고 있는지 알아볼 것입니다. 우리는 스타트업 시작을 최적화 문제로 바꾸고 있습니다. 코드를 최적화해 본 사람이라면 누구나 그런 좁은 집중이 얼마나 놀랍도록 효과적인지 알 것입니다. 코드 최적화는 기존 프로그램을 가져와 일반적으로 시간이나 메모리와 같은 것을 덜 사용하도록 변경하는 것을 의미합니다. 프로그램이 무엇을 해야 하는지 생각할 필요 없이 그냥 더 빠르게 만들면 됩니다. 대부분의 프로그래머에게 이것은 매우 만족스러운 작업입니다. 좁은 집중은 그것을 일종의 퍼즐로 만들고, 당신은 일반적으로 얼마나 빨리 그것을 풀 수 있는지 놀라게 됩니다.",
    },
    {
        english:
            "Focusing on hitting a growth rate reduces the otherwise bewilderingly multifarious problem of starting a startup to a single problem. You can use that target growth rate to make all your decisions for you; anything that gets you the growth you need is ipso facto right. Should you spend two days at a conference? Should you hire another programmer? Should you focus more on marketing? Should you spend time courting some big customer? Should you add x feature? Whatever gets you your target growth rate. [8](Within YC when we say it's ipso facto right to do whatever gets you growth, it's implicit that this excludes trickery like buying users for more than their lifetime value, counting users as active when they're really not, bleeding out invites at a regularly increasing rate to manufacture a perfect growth curve, etc. Even if you were able to fool investors with such tricks, you'd ultimately be hurting yourself, because you're throwing off your own compass.)",
        korean: "성장률 달성에 집중하는 것은 스타트업 시작이라는 혼란스럽고 다면적인 문제를 단일 문제로 축소시킵니다. 목표 성장률을 사용하여 모든 결정을 내릴 수 있습니다. 필요한 성장을 가져다주는 모든 것은 그 자체로 옳습니다. 컨퍼런스에 이틀을 보내야 할까요? 다른 프로그래머를 고용해야 할까요? 마케팅에 더 집중해야 할까요? 큰 고객을 유치하는 데 시간을 보내야 할까요? X 기능을 추가해야 할까요? 목표 성장률을 달성하게 해주는 것이라면 무엇이든 좋습니다. [8](YC 내에서 성장을 가져다주는 모든 것이 그 자체로 옳다고 말할 때, 이는 평생 가치보다 비싸게 사용자를 구매하거나, 실제로는 활성 상태가 아닌 사용자를 활성 상태로 계산하거나, 완벽한 성장 곡선을 만들기 위해 정기적으로 증가하는 비율로 초대장을 유출하는 등의 속임수를 제외한다는 것이 암묵적으로 전제됩니다. 그러한 속임수로 투자자를 속일 수 있다 하더라도, 결국에는 자신의 나침반을 망가뜨리는 것이므로 자신을 해치게 될 것입니다.)",
    },
    {
        english:
        ...
        korean: "주간 성장으로 자신을 판단한다고 해서 일주일 앞만 내다볼 수 있다는 의미는 아닙니다. 일주일 목표를 놓치는 고통(그것만이 중요했고, 당신은 실패했습니다)을 경험하고 나면, 미래에 그런 고통을 면하게 해줄 수 있는 모든 것에 관심을 갖게 됩니다. 그래서 예를 들어 이번 주 성장에 기여하지는 않지만 아마도 한 달 안에 더 많은 사용자를 확보할 수 있는 새로운 기능을 구현할 다른 프로그래머를 기꺼이 고용할 의향이 생길 것입니다. 그러나 (a) 누군가를 고용하는 데 따른 주의 산만이 단기적으로 목표 달성을 놓치게 만들지 않고, (b) 새로운 사람을 고용하지 않고도 계속 목표를 달성할 수 있을지에 대해 충분히 걱정하는 경우에만 해당됩니다.",
    },
    {
        english:
            "It's not that you don't think about the future, just that you think about it no more than necessary.",
        korean: "미래에 대해 생각하지 않는 것이 아니라, 필요 이상으로 생각하지 않는 것뿐입니다. 이것이 핵심입니다.",
    },
    {
        english:
        ...
        korean: "이론적으로 이런 종류의 언덕 오르기(점진적 개선)는 스타트업을 곤경에 빠뜨릴 수 있습니다. 그들은 지역적 최적점(local maximum)에 머무를 수 있습니다. 그러나 실제로는 그런 일이 거의 일어나지 않습니다. 매주 성장 목표를 달성해야 한다는 점은 창업자들이 행동하도록 강요하며, 행동하는 것과 행동하지 않는 것이 성공의 가장 중요한 부분입니다. 열에 아홉은 앉아서 전략을 짜는 것은 단지 꾸물거림의 한 형태일 뿐입니다. 반면에 어떤 언덕을 올라야 할지에 대한 창업자들의 직관은 그들이 깨닫는 것보다 보통 더 낫습니다. 게다가 스타트업 아이디어 공간의 최적점들은 뾰족하고 고립되어 있지 않습니다. 대부분의 꽤 좋은 아이디어들은 훨씬 더 좋은 아이디어들과 인접해 있습니다.",
    },
    {
        english:
        ...
        korean: "성장을 위한 최적화의 매력적인 점은 실제로 스타트업 아이디어를 발견할 수 있다는 것입니다. 성장에 대한 필요성을 진화적 압력의 한 형태로 사용할 수 있습니다. 초기 계획으로 시작하여 주당 10%와 같은 성장률을 계속 달성하기 위해 필요에 따라 수정하면, 시작하려고 했던 회사와는 상당히 다른 회사로 끝날 수 있습니다. 그러나 주당 10%씩 꾸준히 성장하는 것은 거의 확실히 시작했던 아이디어보다 더 나은 아이디어입니다.",
    },
    {
        english:
    ...
    },
    {
        ...
        korean: "우리 조상들은 기하급수적인 성장의 경우를 거의 접하지 못했을 것이므로, 우리의 직관은 여기서 아무런 도움이 되지 못합니다. 빠르게 성장하는 스타트업에 일어나는 일은 창업자들조차 놀라게 하는 경향이 있습니다.",
    },
    {
        english:
        ...
        korean: "성장률의 작은 차이가 질적으로 다른 결과를 낳습니다. 이것이 스타트업이라는 별도의 단어가 있는 이유이며, 스타트업이 자금 조달 및 인수와 같이 일반 회사가 하지 않는 일을 하는 이유입니다. 그리고 이상하게도, 이것이 그들이 그렇게 자주 실패하는 이유이기도 합니다.",
    },
    {
        english:
        ...
        korean: "성공적인 스타트업이 얼마나 가치 있게 될 수 있는지를 고려하면, 기대값 개념에 익숙한 사람이라면 실패율이 높지 않다면 놀랄 것입니다. 성공적인 스타트업이 창업자에게 1억 달러를 벌어줄 수 있다면, 성공 확률이 단 1%에 불과하더라도 스타트업을 시작하는 것의 기대값은 100만 달러가 될 것입니다. 그리고 충분히 똑똑하고 단호한 창업자 그룹이 그 규모로 성공할 확률은 1%를 훨씬 넘을 수 있습니다. 적합한 사람들, 예를 들어 젊은 빌 게이츠의 경우 그 확률은 20% 또는 심지어 50%일 수도 있습니다. 따라서 그렇게 많은 사람들이 도전하고 싶어하는 것은 놀라운 일이 아닙니다. 효율적인 시장에서 실패한 스타트업의 수는 성공의 규모에 비례해야 합니다. 그리고 후자가 막대하므로 전자도 그래야 합니다. [11](모든 기대값 계산은 돈에 대한 효용 함수에 따라 사람마다 다릅니다. 즉, 대부분의 사람들에게 첫 백만 달러는 그 이후의 백만 달러보다 더 가치가 있습니다. 얼마나 더 가치가 있는지는 사람에 따라 다릅니다. 더 젊거나 야심 찬 창업자들의 경우 효용 함수가 더 평평합니다. 이것이 아마도 가장 성공적인 스타트업 창업자들이 젊은 편인 경향이 있는 이유 중 하나일 것입니다.)",
    },
    {
        english:
        ...
        korean: "이것이 의미하는 바는, 어느 시점에서든 대다수의 스타트업은 결코 성공하지 못할 무언가에 매달리고 있으면서도, 그들의 운명 지워진 노력을 '스타트업'이라는 거창한 이름으로 미화하고 있다는 것입니다.",
    },
    {
        english:
        ...
        korean: "이것은 저를 괴롭히지 않습니다. 배우나 소설가와 같은 다른 고위험 직업과 마찬가지입니다. 저는 오래전에 그것에 익숙해졌습니다. 하지만 많은 사람들, 특히 일반적인 사업을 시작한 사람들을 괴롭히는 것 같습니다. 많은 사람들이 이른바 스타트업들이 거의 아무것도 이루지 못할 것처럼 보이기 때문에 짜증을 냅니다.",
    },
    {
        english:
        ...
        korean: "인스타그램이 가치 없었다는 잘못된 가정에서 시작한다면, 마크 저커버그에게 그것을 사도록 강요하는 비밀 보스를 만들어내야 합니다. 마크 저커버그를 아는 사람이라면 누구나 그것이 초기 가정의 귀류법적 귀결(reductio ad absurdum)이라는 것을 알 것입니다. 그가 인스타그램을 인수한 이유는 그것이 가치 있고 위험했기 때문이며, 그렇게 만든 것은 성장이었습니다.",
    },
    {
        english:
        ...
        korean: "스타트업을 이해하고 싶다면 성장을 이해해야 합니다. 성장은 이 세상 모든 것을 움직입니다. 스타트업이 주로 기술 분야에서 일하는 이유는 성장입니다. 빠르게 성장하는 회사에 대한 아이디어는 매우 드물기 때문에 새로운 아이디어를 찾는 가장 좋은 방법은 변화에 의해 최근에 실행 가능해진 아이디어를 발견하는 것이며, 기술은 빠른 변화의 가장 좋은 원천입니다. 성장은 많은 창업자들이 경제적으로 스타트업을 시작하려고 하는 합리적인 선택인 이유입니다. 성장은 성공적인 회사를 매우 가치 있게 만들어 위험이 너무 크더라도 기대값이 높기 때문입니다. 성장은 VC가 스타트업에 투자하기를 좋아하는 이유입니다. 수익이 높기 때문일 뿐만 아니라 자본 이득으로부터 수익을 창출하는 것이 배당금으로부터 수익을 창출하는 것보다 관리하기 쉽기 때문입니다. 성장은 가장 성공적인 스타트업이 필요하지 않더라도 VC 자금을 받는 이유입니다. 이를 통해 성장률을 선택할 수 있습니다. 그리고 성장은 성공적인 스타트업이 거의 예외 없이 인수 제안을 받는 이유입니다. 인수자에게 빠르게 성장하는 회사는 단지 가치가 있을 뿐만 아니라 위험하기도 합니다.",
    },
    {
        english: "Understand",
        korean: "이해",
    },
    {
        ...
        korean: "창업자, 투자자, 인수자의 조합은 자연스러운 생태계를 형성합니다. 너무나 잘 작동해서 그것을 이해하지 못하는 사람들은 때때로 일이 얼마나 깔끔하게 풀리는지 설명하기 위해 음모론을 만들어내기에 이릅니다. 마치 우리 조상들이 자연계의 너무나 깔끔해 보이는 작동 방식을 설명하기 위해 그랬던 것처럼 말입니다. 그러나 이 모든 것을 작동시키는 비밀 결사 조직은 없습니다.",
    },
    {
        english:
            "If you start from the mistaken assumption that Instagram was worthless, you have to invent a secret boss to force Mark Zuckerberg to buy it. To anyone who knows Mark Zuckerberg, that is the reductio ad absurdum of the initial assumption. The reason he bought Instagram was that it was valuable and dangerous, and what made it so was growth.",
    ...
    },
    {
        english:
            "If you want to understand startups, understand growth. Growth drives everything in this world. Growth is why startups usually work on technology — because ideas for fast growing companies are so rare that the best way to find new ones is to discover those recently made viable by change, and technology is the best source of rapid change. Growth is why it's a rational choice economically for so many founders to try starting a startup: growth makes the successful companies so valuable that the expected value is high even though the risk is too. Growth is why VCs want to invest in startups: not just because the returns are high but also because generating returns from capital gains is easier to manage than generating returns from dividends. Growth explains why the most successful startups take VC money even if they don't need to: it lets them choose their growth rate. And growth explains why successful startups almost invariably get acquisition offers. To acquirers a fast-growing company is not merely valuable but dangerous too.",
        korean: "스타트업을 이해하고 싶다면 성장을 이해해야 합니다. 성장은 이 세상 모든 것을 움직입니다. 스타트업이 주로 기술 분야에서 일하는 이유는 성장입니다. 빠르게 성장하는 회사에 대한 아이디어는 매우 드물기 때문에 새로운 아이디어를 찾는 가장 좋은 방법은 변화에 의해 최근에 실행 가능해진 아이디어를 발견하는 것이며, 기술은 빠른 변화의 가장 좋은 원천입니다. 성장은 많은 창업자들이 경제적으로 스타트업을 시작하려고 하는 합리적인 선택인 이유입니다. 성장은 성공적인 회사를 매우 가치 있게 만들어 위험이 너무 크더라도 기대값이 높기 때문입니다. 성장은 VC가 스타트업에 투자하고 싶어하는 이유입니다. 수익이 높기 때문일 뿐만 아니라 자본 이득으로부터 수익을 창출하는 것이 배당금으로부터 수익을 창출하는 것보다 관리하기 쉽기 때문입니다. 성장은 가장 성공적인 스타트업이 필요하지 않더라도 VC 자금을 받는 이유를 설명합니다. 이를 통해 성장률을 선택할 수 있습니다. 그리고 성장은 성공적인 스타트업이 거의 예외 없이 인수 제안을 받는 이유를 설명합니다. 인수자에게 빠르게 성장하는 회사는 단지 가치가 있을 뿐만 아니라 위험하기도 합니다.",
    },
    {
        english:
        ...
        korean: "어떤 영역에서 성공하고 싶다면 그것을 움직이는 힘을 이해해야 한다는 것만이 아닙니다. 성장을 이해하는 것이 바로 스타트업을 시작하는 것입니다. 스타트업을 시작할 때 당신이 실제로 하는 일(그리고 일부 관찰자들을 실망스럽게도, 당신이 실제로 하는 모든 일)은 일반적인 사업보다 더 어려운 유형의 문제를 해결하겠다고 약속하는 것입니다. 당신은 빠른 성장을 창출하는 희귀한 아이디어 중 하나를 찾겠다고 약속하는 것입니다. 이러한 아이디어는 매우 가치가 있기 때문에 하나를 찾는 것은 어렵습니다. 스타트업은 지금까지 당신의 발견의 구체화입니다. 따라서 스타트업을 시작하는 것은 연구 과학자가 되기로 결정하는 것과 매우 유사합니다. 특정 문제를 해결하겠다고 약속하는 것이 아닙니다. 어떤 문제가 해결 가능한지 확실히 알지 못합니다. 그러나 이전에 아무도 몰랐던 무언가를 발견하려고 노력하겠다고 약속하는 것입니다. 스타트업 창업자는 사실상 경제 연구 과학자입니다. 대부분은 그렇게 주목할 만한 것을 발견하지 못하지만, 어떤 사람들은 상대성 이론을 발견합니다.",
    },
    {
        english:
            "The fascinating thing about optimizing for growth is that it can actually discover startup ideas. You can use the need for growth as a form of evolutionary pressure. If you start out with some initial plan and modify it as necessary to keep hitting, say, 10% weekly growth, you may end up with a quite different company than you meant to start. But anything that grows consistently at 10% a week is almost certainly a better idea than you started with.",
    ...
    },
    {
        ...
        korean: "만약 그들이 한 걸음 물러서서 전체 그림을 본다면 덜 분개할지도 모릅니다. 그들이 저지르는 실수는 일화적 증거에 의견을 근거함으로써 평균이 아닌 중앙값으로 암묵적으로 판단하고 있다는 것입니다. 중앙값 스타트업으로 판단한다면 스타트업이라는 개념 전체가 사기처럼 보입니다. 창업자들이 왜 스타트업을 시작하고 싶어하는지 또는 투자자들이 왜 자금을 지원하고 싶어하는지 설명하기 위해 거품을 만들어내야 합니다. 그러나 변동성이 매우 큰 영역에서 중앙값을 사용하는 것은 실수입니다. 중앙값이 아닌 평균 결과를 보면 투자자들이 왜 그들을 좋아하는지, 그리고 그들이 평균적인 사람들이 아니라면 창업자들이 스타트업을 시작하는 것이 합리적인 선택인 이유를 이해할 수 있습니다.",
    },
    {
        english: "Deals",
        korean: "거래",
    },
    {
        ...
        korean: "왜 투자자들은 스타트업을 그렇게 좋아할까요? 왜 그들은 탄탄한 수익 사업보다는 사진 공유 앱에 그렇게 열광적으로 투자할까요? 명백한 이유 때문만은 아닙니다.",
    },
    {
        english:
        ...
        korean: "모든 투자의 시험대는 수익 대 위험 비율입니다. 스타트업은 끔찍하게 위험하지만 성공했을 때 수익이 매우 높기 때문에 그 시험을 통과합니다. 그러나 이것만이 투자자들이 스타트업을 좋아하는 유일한 이유는 아닙니다. 일반적인 느리게 성장하는 사업은 수익과 위험이 모두 낮다면 수익 대 위험 비율이 똑같이 좋을 수 있습니다. 그렇다면 왜 VC(벤처 캐피털)는 고성장 회사에만 관심을 가질까요? 그 이유는 그들이 자본을 회수함으로써, 이상적으로는 스타트업 IPO(기업 공개) 이후에, 또는 그것이 실패하면 인수될 때 보상을 받기 때문입니다.",
    },
    {
        english:
        ...
        korean: "투자로부터 수익을 얻는 또 다른 방법은 배당금 형태입니다. 왜 이익의 일정 비율을 대가로 일반 회사에 투자하는 병행 VC 산업은 없을까요? 사기업을 지배하는 사람들이 회사가 거의 이익을 내지 않는 것처럼 보이게 하면서 (예를 들어, 자신이 통제하는 공급업체로부터 고가의 부품을 구매함으로써) 수익을 자신에게 빼돌리기가 너무 쉽기 때문입니다. 배당금을 대가로 사기업에 투자하는 사람은 누구나 그들의 장부를 면밀히 주시해야 할 것입니다.",
    },
    {
        english:
            "The reason VCs like to invest in startups is not simply the returns, but also because such investments are so easy to oversee. The founders can't enrich themselves without also enriching the investors. [12](More precisely, this is the case in the biggest winners, which is where all the returns come from. A startup founder could pull the same trick of enriching himself at the company's expense by selling them overpriced components. But it wouldn't be worth it for the founders of Google to do that. Only founders of failing startups would even be tempted, but those are writeoffs from the VCs' point of view anyway.)",
        korean: "VC들이 스타트업에 투자하기를 좋아하는 이유는 단순히 수익 때문만이 아니라, 그러한 투자가 감독하기 매우 쉽기 때문이기도 합니다. 창업자들은 투자자들을 부유하게 만들지 않고서는 자신들도 부유해질 수 없습니다. [12](더 정확히 말하면, 모든 수익이 발생하는 가장 큰 성공 사례에서 그렇습니다. 스타트업 창업자는 회사에 고가의 부품을 판매하여 회사 비용으로 자신을 부유하게 만드는 동일한 속임수를 쓸 수 있습니다. 그러나 구글 창업자들에게는 그렇게 할 가치가 없을 것입니다. 실패하는 스타트업의 창업자들만이 유혹을 받을 것이지만, 어쨌든 VC의 관점에서 보면 그것들은 손실 처리 대상입니다.)",
    },
    {
        english:
        ...
        korean: "왜 창업자들은 VC의 돈을 받고 싶어 할까요? 다시 한번, 성장입니다. 좋은 아이디어와 성장 사이의 제약은 양방향으로 작용합니다. 성장하기 위해 확장 가능한 아이디어가 필요한 것만이 아닙니다. 그런 아이디어가 있고 충분히 빠르게 성장하지 않으면 경쟁자들이 나타날 것입니다. 너무 느리게 성장하는 것은 네트워크 효과가 있는 사업에서 특히 위험하며, 최고의 스타트업은 보통 어느 정도 네트워크 효과를 가지고 있습니다.",
    },
    {
        english:
        ...
        korean: "거의 모든 회사가 시작하려면 어느 정도의 자금이 필요합니다. 그러나 스타트업은 수익성이 있거나 있을 수 있을 때에도 종종 자금을 조달합니다. 수익성 있는 회사의 주식을 나중에 가치가 있을 것이라고 생각하는 것보다 낮은 가격에 파는 것은 어리석어 보일 수 있지만, 보험에 가입하는 것보다 더 어리석은 일은 아닙니다. 근본적으로 가장 성공적인 스타트업은 자금 조달을 그렇게 봅니다. 그들은 자체 수익으로 회사를 성장시킬 수 있지만, VC가 제공하는 추가 자금과 도움은 그들이 훨씬 더 빠르게 성장할 수 있도록 해줄 것입니다. 자금 조달은 성장률을 선택할 수 있게 해줍니다.",
    },
    {
        english:
        ...
        korean: "더 빠르게 성장하기 위한 자금은 항상 가장 성공적인 스타트업의 손에 달려 있습니다. 왜냐하면 VC는 스타트업보다 그들을 더 필요로 하기 때문입니다. 수익성 있는 스타트업은 원한다면 자체 수익으로 성장할 수 있습니다. 더 느리게 성장하는 것은 약간 위험할 수 있지만, 그들을 죽이지는 않을 가능성이 큽니다. 반면에 VC는 스타트업, 특히 가장 성공적인 스타트업에 투자해야 하며, 그렇지 않으면 사업을 접어야 합니다. 이는 충분히 유망한 스타트업에게는 거절하기에는 너무나 좋은 조건으로 자금이 제공될 것이라는 것을 의미합니다. 그럼에도 불구하고 스타트업 사업의 성공 규모 때문에 VC는 여전히 그러한 투자로부터 돈을 벌 수 있습니다. 높은 성장률이 회사를 그렇게 가치 있게 만들 것이라고 믿으려면 미쳤다고 해야겠지만, 어떤 사람들은 그렇게 믿습니다.",
    },
    {
        english:
            "Pretty much every successful startup will get acquisition offers too. Why? What is it about startups that makes other companies want to buy them? [13](Acquisitions fall into two categories: those where the acquirer wants the business, and those where the acquirer just wants the employees. The latter type is sometimes called an HR acquisition. Though nominally acquisitions and sometimes on a scale that has a significant effect on the expected value calculation for potential founders, HR acquisitions are viewed by acquirers as more akin to hiring bonuses.)",
        korean: "거의 모든 성공적인 스타트업은 인수 제안도 받게 될 것입니다. 왜 그럴까요? 다른 회사들이 스타트업을 사고 싶어하게 만드는 스타트업의 특징은 무엇일까요? [13](인수는 두 가지 범주로 나뉩니다. 인수자가 사업 자체를 원하는 경우와 인수자가 단지 직원을 원하는 경우입니다. 후자 유형은 때때로 HR 인수라고 불립니다. 명목상 인수이고 때로는 잠재적 창업자의 기대값 계산에 상당한 영향을 미치는 규모이지만, HR 인수는 인수자에게 채용 보너스와 더 유사한 것으로 간주됩니다.)",
    },
    {
        english:
        ...
        korean: "근본적으로 다른 모든 사람들이 성공적인 스타트업의 주식을 원하는 것과 같은 이유입니다. 빠르게 성장하는 회사는 가치가 있습니다. 예를 들어 이베이가 페이팔을 인수한 것은 좋은 일입니다. 왜냐하면 페이팔은 현재 이베이 매출의 43%를 차지하고 있으며 아마도 성장에는 더 큰 기여를 하고 있을 것이기 때문입니다.",
    },
    {
        english:
            "But acquirers have an additional reason to want startups. A rapidly growing company is not merely valuable, but dangerous. If it keeps expanding, it might expand into the acquirer's own territory. Most product acquisitions have some component of fear. Even if an acquirer isn't threatened by the startup itself, they might be alarmed at the thought of what a competitor could do with it. And because startups are in this sense doubly valuable to acquirers, acquirers will often pay more than an ordinary investor would. [14](I once explained this to some founders who had recently arrived from Russia. They found it novel that if you threatened a company they'd pay a premium for you. \"In Russia they just kill you,\" they said, and they were only partly joking. Economically, the fact that established companies can't simply eliminate new competitors may be one of the most valuable aspects of the rule of law. And so to the extent we see incumbents suppressing competitors via regulations or patent suits, we should worry, not because it's a departure from the rule of law per se but from what the rule of law is aiming at.)",
        korean: '그러나 인수자들은 스타트업을 원하는 추가적인 이유가 있습니다. 빠르게 성장하는 회사는 단지 가치가 있을 뿐만 아니라 위험하기도 합니다. 계속 확장하면 인수자의 영역으로 확장될 수 있습니다. 대부분의 제품 인수에는 어느 정도 두려움의 요소가 있습니다. 인수자가 스타트업 자체에 위협을 느끼지 않더라도 경쟁자가 그것으로 무엇을 할 수 있을지에 대한 생각에 놀랄 수 있습니다. 그리고 이러한 의미에서 스타트업은 인수자에게 이중으로 가치가 있기 때문에 인수자는 종종 일반 투자자보다 더 많은 비용을 지불할 것입니다. [14](저는 러시아에서 막 도착한 몇몇 창업자들에게 이 점을 설명한 적이 있습니다. 그들은 회사를 위협하면 프리미엄을 지불한다는 사실을 신기하게 여겼습니다. "러시아에서는 그냥 죽여버리죠."라고 그들은 말했고, 부분적으로만 농담이었습니다. 경제적으로 볼 때, 기존 회사가 새로운 경쟁자를 단순히 제거할 수 없다는 사실은 법치주의의 가장 가치 있는 측면 중 하나일 수 있습니다. 따라서 기존 기업이 규제나 특허 소송을 통해 경쟁자를 억압하는 것을 볼 때, 우리는 그것이 법치주의 자체에서 벗어났기 때문이 아니라 법치주의가 목표로 하는 것에서 벗어났기 때문에 걱정해야 합니다.)',
    },
    {
        english: "Understand",
        korean: "이해",
